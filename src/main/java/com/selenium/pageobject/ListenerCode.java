...
public class ListenerCode implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		System.out.println("on passed : "+result.getMethod().getMethodName());
			...
			try {
				FixedDeposit_PageObj.takeSreenshot("Pass", result.getMethod().getMethodName());
			} catch (Exception e) {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			FixedDeposit_PageObj.takeSreenshot("Fail", result.getMethod().getMethodName());
		} catch (Exception e) {
	...
	public void onTestSkipped(ITestResult result) {
		...
		try {
			FixedDeposit_PageObj.takeSreenshot("Skip", result.getMethod().getMethodName());
		} catch (Exception e) {
