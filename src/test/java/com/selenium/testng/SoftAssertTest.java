 ...
 *  This class contin code for hard assert
 * 
 */
public class SoftAssertTest 
{
  ...
  public void homePageTest() throws Exception
  {
	 ...
	 sft.assertTrue(pageTitle.contains("Zoopla") ,"Title does not contain Zoopla");
  ...
  public void verifySearchTest() throws Exception
  {
	  ...
	  sft.assertTrue(pageTitle.contains("London"), "page title does not contains London");
	  sft.assertEquals(pageLable.getText(), "Property for sale in London");
	  sft.assertAll();
  }
  ...
  public void propertyDetailTest() throws Exception
  {
	  ...
	  sft.assertEquals( houseActual.getText().trim(), houseExpexted);
